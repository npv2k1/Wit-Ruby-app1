...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { entity: @entity.entity, intent: @entity.intent } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { entity: @entity.entity, intent: @entity.intent } }
