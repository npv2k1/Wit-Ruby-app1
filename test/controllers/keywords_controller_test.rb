...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { entity: @keyword.entity, keyword: @keyword.keyword, synonyms: @keyword.synonyms } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { entity: @keyword.entity, keyword: @keyword.keyword, synonyms: @keyword.synonyms } }
